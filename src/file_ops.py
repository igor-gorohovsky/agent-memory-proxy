...
class FileOperations:
    ...
    @staticmethod
    def write_file(path: Path, content: str, encoding: str = config.DEFAULT_ENCODING) -> None:
...
class PathUtils:
    ...
    @staticmethod
    def get_relative_path_info(file_path: Path, base_path: Path) -> Tuple[str, str]:
    ...
    def _load_gitignore_spec(self, directory: Path) -> Optional[pathspec.PathSpec]:
        ...
        try:
            ...
            for gitignore_file in gitignore_files:
                with open(gitignore_file, 'r', encoding=config.DEFAULT_ENCODING) as f:
